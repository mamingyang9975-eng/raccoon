const QUESTIONS = [
  ["下水道醒来", "你被井盖缝里漏下来的阳光晃醒。今天第一反应是：", [
    ["查一下今天的工作计划，安排安排！", { DO: 2, SAFE: 1 }],
    ["先刷会儿人类短视频，等灵感上线", { AVOID: 2, DRAMA: 1 }],
    ["os：熊一直躺在床上会不会死", { DRAMA: 2, DO: -1 }]
  ]],
  ...
  ["街区社交", "路边碰见流浪猫，对方气场很强。你会：", [
    ...
    ["今天太阳真好，路边小猫咪也是很小猫咪", { SAFE: 1, MASK: 1 }],
    ["默默走进草丛，然后脑补一段宿命对手戏，精彩精彩", { DRAMA: 2, DO: -1 }]
  ]],
  ["公园职业发展", "你听说公园垃圾桶要‘区域承包’。你会：", [
    ["立刻踩点——我就要这一片的垃圾桶！", { DO: 2, SAFE: 1 }],
    ["真的假的？找人问问内幕", { SOCIAL: 2, MASK: 1 }],
  ...
  ["感情支线", "分别时，对方说‘改天见’。你会：", [
    ["当晚发消息，明确下一次，无安排即高风险", { DO: 2, SOCIAL: 1 }],
    ["下次的事情下次再说，熊休息。", { MASK: 2, SAFE: 1 }],
    ["开始想象下一次见面，但是并不想约人出门...", { DRAMA: 2, AVOID: 2 }]
  ]],
  ["自我娱乐", "夜深了，你打开人类论坛：", [
    ["搜索‘塔罗一周运势解读’，安心才好睡觉", { DO: 1, DRAMA: 1 }],
    ["看别人吵架并点赞高赞阴阳，哈哈大晚上还有小品看", { AVOID: 1, DRAMA: 2 }],
    ["（已入梦）", { MASK:1, DO: 2 }]
  ]],
  ["自我娱乐", "朋友发来‘来打游戏’。你会：", [
    ["走！", { SOCIAL: 2, DRAMA: 1 }],
    ["先把手头事做完再玩，熊之克制！", { DO: 2, SAFE: 1 }],
